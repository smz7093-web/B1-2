...
[https://github.com/user-attachments/assets/8419bae3-528e-453c-b1f4-031fcf0bc1bc](https://github.com/smz7093-web/B1-2/issues/1)
...
### 📌 메시지 1: "예당호를 걷고, 지역의 이야기를 듣고, 농부의 밥상을 맛본다"

| 구분 | 내용 |
| :--- | :--- |
| **타깃 (Who)** | 예당호를 찾는 모든 방문객 |
| **핵심 가치 (Value)** | 단순 관광이 아닌 '지역 이해' + '생산자와의 만남' |
| **감성 톤 (Mood)** | 차분하고 의미 있는 여정 (느린 여행의 리듬) |
| **청각 연출 (Audio)** | 발걸음 소리 → 해설사의 목소리 → 농부와 대화 → 함께하는 밥상 |
| **시각 연출 (Visual)** | 호수 풍경 → 마을 이야기 → 식탁 위의 음식 |

---

### 📌 메시지 2: "수몰마을의 기억, 농부의 손길이 담긴 밥상을 맛본다"

| 구분 | 내용 |
| :--- | :--- |
| **타깃 (Who)** | 지역의 역사와 문화에 공감하는 30-60대 여행객 |
| **핵심 가치 (Value)** | 예당호의 '과거'와 '현재'를 동시에 경험 (시간의 깊이) |
| **감성 톤 (Mood)** | 향수적이면서도 따뜻한 감정, 잔잔하고 명상적 |
| **시각 연출 (Visual)** | 수몰마을 이야기 (과거) → 현재 예당호 풍경 → 농부의 손 → 밥상 |

---

### 📌 메시지 3: "농부를 만나고, 그들의 이야기를 듣고, 그들의 손으로 만든 밥상을 함께한다"

| 구분 | 내용 |
| :--- | :--- |
| **타깃 (Who)** | 로컬푸드 및 생산자 가치를 이해하는 고객 (전 연령층) |
| **핵심 가치 (Value)** | 생산자와의 직접 만남 + 투명한 식재료 가치 + 상생의 경험 |
| **감성 톤 (Mood)** | 소박하면서도 고급스러운, 신뢰감 있고 따뜻한 공동체 감각 |
| **시각 연출 (Visual)** | 농부의 얼굴 → 밭에서의 노동 → 수확 → 식탁 → 농부와 방문객이 함께 앉는 장면 |
...
| :--- | :--- |
| **타깃 (Who)** | 예당호 방문객 전체 |
| **어떤 가치 (Value)** | 지역 이해 + 생산자 만남 |
| **어떤 느낌 (Mood)** | 차분한 여정, 의미 있음 |
...
| 구분 | 내용 |
| :--- | :--- |
| **타깃 (Who)** | 역사/문화 공감층 (30-60대) |
| **어떤 가치 (Value)** | 과거와 현재의 연결 |
| **어떤 느낌 (Mood)** | 향수적, 따뜻함, 연결감 |

---

### 📌 메시지 3: "농부를 만나고, 그들의 이야기를 듣고, 함께한다"

| 구분 | 내용 |
| :--- | :--- |
| **타깃 (Who)** | 로컬푸드 가치층 (전 연령) |
| **어떤 가치 (Value)** | 생산자 신뢰 + 상생 경험 |
| **어떤 느낌 (Mood)** | 따뜻함, 진정성, 공동체감 |

🎬 10초 광고 시나리오 예시

### 🎬 메시지 1: 예당호 여정 중심

| 시간 | 연출 장면 (Visual & Audio) |
| :---: | :--- |
| **0 ~ 2초** | 발걸음 소리, 예당호 수변길 걷는 모습 |
| **2 ~ 4초** | 마을해설사의 목소리 (수몰마을 이야기) |
| **4 ~ 7초** | 농부의 얼굴, 식탁 위의 음식 |
| **7 ~ 10초** | **자막:** *"예당호를 걷고, 지역의 이야기를 듣고, 농부의 밥상을 맛본다"*<br>**브랜드:** 예당 스토리 테이블 |
...
| **3 ~ 6초** | 현재의 예당호 풍경 (현재) |
| **6 ~ 8초** | 농부의 손, 밥상 |
| **8 ~ 10초** | **자막:** *"수몰마을의 기억, 농부의 손길이 담긴 밥상을 맛본다"*<br>**브랜드:** 예당 스토리 테이블 |
...
| **7 ~ 10초** | **자막:** *"농부를 만나고, 그들의 이야기를 듣고, 함께한다"*<br>**브랜드:** 예당 스토리 테이블 |
